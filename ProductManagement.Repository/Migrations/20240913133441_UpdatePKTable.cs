...
{
    /// <inheritdoc />
    public partial class UpdatePKTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__19093A0B58FF0DBE", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Member__0CF04B188941B9C5", x => x.MemberId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Product__B40CC6CD608DF7DC", x => x.ProductId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Order__C3905BCF57FD1704", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK__Order__MemberId__398D8EEE",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__08D097A31705B5E7", x => new { x.OrderId, x.ProductId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__OrderDeta__Produ__4222D4EF",
